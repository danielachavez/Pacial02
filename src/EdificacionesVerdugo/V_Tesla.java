 ...
 */
public class V_Tesla implements Verdugo{
    ...
    public V_Tesla(Jugador jugador) {
    ...
    public void construir(Jugador jugador){
        ...
        if(a.getJugador().getC_mando().getRecurso1() >= costo 
           && a.getJugador().getC_mando().getRecurso2() >= costo){
            total = a.getJugador().getC_mando().getRecurso1()-costo;  
            a.getJugador().getC_mando().setRecurso1(total);
            total1 = a.getJugador().getC_mando().getRecurso2()-costo;
            a.getJugador().getC_mando().setRecurso2(total1);
